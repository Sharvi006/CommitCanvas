...
// import Play from './play.jsx'; // Importing your visualizer component

// export default function CommitCanvas() {
//   // Simple state to control current view ('home' or 'playground')
//   const [activeTab, setActiveTab] = useState('home');

//   // Handle scrollytelling animations
//   useEffect(() => {
//     if (activeTab !== 'home') return; // Only run on home view
...
//   const [playgroundKey, setPlaygroundKey] = useState(0); // Key to force re-render/reset Play component
...
//   // Handler for resetting playground
//   const handleResetPlayground = () => {
//     setCommandInput('');
//     setActiveCommand('');
//     setPlaygroundKey((prev) => prev + 1); // Triggers full re-mount reset
//   };
...
//         .navbar-wrapper { position: fixed; top: 24px; left: 0; right: 0; display: flex; justify-content: center; z-index: 100; }
//         .pill-nav { display: flex; align-items: center; justify-content: space-between; width: 100%; max-width: 800px; height: 56px; background: rgba(22, 27, 34, 0.6); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px); border: 1px solid var(--border-color); border-radius: 100px; padding: 0 12px; box-shadow: 0 16px 32px rgba(0, 0, 0, 0.4); }
//         .logo-circle { width: 36px; height: 36px; background: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; }
//         .nav-center { display: flex; gap: 32px; }
//         .nav-center button { background: none; border: none; color: var(--text-secondary); font-size: 14px; font-weight: 500; cursor: pointer; transition: color 0.2s; }
//         .nav-center button:hover, .nav-center button.active { color: white; }
//         .btn-login { background: white; color: #0d1117; padding: 8px 20px; border-radius: 100px; text-decoration: none; font-size: 14px; font-weight: 600; transition: opacity 0.2s; }
//         .btn-login:hover { opacity: 0.9; }

//         /* Playground Container & Pop-up Effect */
...
//         /* Playground Command Console Section */
...
//           align-items: center;
//           gap: 8px;
//           box-shadow: 0 0 15px rgba(110, 86, 207, 0.5), 0 0 30px rgba(88, 166, 255, 0.3);
//           transition: all 0.25s ease;
//         }

//         .glow-btn-purple:hover {
//           transform: translateY(-2px);
//           box-shadow: 0 0 22px rgba(110, 86, 207, 0.8), 0 0 40px rgba(88, 166, 255, 0.5);
...
//       {/* CONDITIONAL RENDER: Show Playground OR Home Page */}
//       {activeTab === 'playground' ? (
//         <div className="playground-view-container" key={playgroundKey}>
//           {/* Main Visualizer Playground View */}
//           <Play commandToExecute={activeCommand} />

//           {/* Dedicated Terminal Input Box matching Width */}
...
//                 <span className="dot green"></span>
//               </div>
//               <div className="terminal-title">CLI Command Input Terminal</div>
//             </div>
...
//                   placeholder="Type git command here... (e.g. git commit -m 'feat: ready')"
//                   value={commandInput}
...
// import Play from "./play"; // Ensure correct relative path

// export default function App() {
//   const [cliInput, setCliInput] = useState("");
//   const [commandToPass, setCommandToPass] = useState("");
...
//     // Send command to Play component
//     setCommandToPass(cliInput.trim());
//     setCliInput(""); // Clear external CLI input bar
//   };
...
//           <h1>Commit Canvas Visualizer</h1>
//         </div>
//         <div className="header-status">
//           <span className="dot-online"></span> CLI Connected
//         </div>
//       </header>

//       {/* Main Play Visualizer Component */}
//       <main className="app-body">
//         <Play commandToExecute={commandToPass} />
//       </main>

//       {/* External CLI Command Input Container */}
//       <footer className="cli-container-wrapper">
//         <form onSubmit={handleCommandSubmit} className="cli-input-box">
//           <span className="cli-symbol">&gt;</span>
//           <input
//             type="text"
//             value={cliInput}
//             onChange={(e) => setCliInput(e.target.value)}
//             placeholder="Type CLI Command (e.g. git init, git add ., git commit -m 'initial commit', git push)..."
//             className="cli-input"
//           />
//           <button type="submit" className="cli-run-btn">
//             Run Command
//           </button>
//         </form>
//       </footer>
...
//         /* External CLI Input Container (Bottom Bar) */
//         .cli-container-wrapper {
//           width: 100%;
//           max-width: 1000px;
//           position: sticky;
//           bottom: 15px;
...
import React, { useState, useEffect } from 'react';
import Play from './play.jsx'; // Visualizer component
